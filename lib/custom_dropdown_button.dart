...
const double _kDenseButtonHeight = 0;
const EdgeInsets _kMenuItemPadding = EdgeInsets.symmetric(horizontal: 0);
const EdgeInsetsGeometry _kAlignedButtonPadding = EdgeInsetsDirectional.only(start: 0, end: 0);
const EdgeInsets _kUnalignedButtonPadding = EdgeInsets.zero;
const EdgeInsets _kAlignedMenuMargin = EdgeInsets.zero;
const EdgeInsetsGeometry _kUnalignedMenuMargin = EdgeInsetsDirectional.only(start: 2, end: 2);
...
/// To update from [CustomDropdownButton] to [DropdownMenu], you will
/// need to make the following changes:
///
/// 1. Instead of using [CustomDropdownButton.items], which
/// takes a list of [CustomDropdownMenuItem]s, use
/// [DropdownMenu.dropdownMenuEntries], which
/// takes a list of [DropdownMenuEntry]'s.
///
/// 2. Instead of using [CustomDropdownButton.onChanged],
...
/// the [CustomDropdownButton.value] property, you can set the
...
/// from [CustomDropdownButton] to [DropdownMenu].
///
/// ## Using [CustomDropdownButton]
...
///
/// {@tool dartpad}
/// This sample shows how you would rewrite the above [CustomDropdownButton]
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// As the padding increases, the size of the [CustomDropdownButton] will also
