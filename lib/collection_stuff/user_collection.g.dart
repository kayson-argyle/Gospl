...
int _userCollectionEstimateSize(
  ...
  bytesCount += 3 + object.works.length * 3;
  {
    for (var i = 0; i < object.works.length; i++) {
      final value = object.works[i];
...
void _userCollectionSerialize(
  ...
  writer.writeBool(offsets[1], object.isCollaborative);
  writer.writeString(offsets[2], object.name);
  writer.writeStringList(offsets[3], object.works);
}
...
UserCollection _userCollectionDeserialize(
  ...
  object.id = id;
  object.isCollaborative = reader.readBool(offsets[1]);
  object.works = reader.readStringList(offsets[3]) ?? [];
  return object;
}
...
extension UserCollectionQueryFilter
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      worksElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'works',
        value: value,
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      worksElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'works',
        wildcard: pattern,
...
extension UserCollectionQuerySortBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByArchived() {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQuerySortThenBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'archived', Sort.asc);
    });
  }
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByArchived() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByWorks() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'works');
    });
  }
}
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, bool, QQueryOperations> archivedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, List<String>, QQueryOperations> worksProperty() {
    return QueryBuilder.apply(this, (query) {
